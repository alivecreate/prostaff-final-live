    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('blog.create')}}" class="btn btn-primary mt-md-0 mt-2">Add New {{ isset($page['name']) ? $page['name'] : 'item' }}</a>
            </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex vendor-list banner-section">
                                        <img src="{{ asset('web/media/sm') }}/{{$blog->image}}" height="100" alt=""
                                ...
                                <td>
                                    ...
                                    class="btn btn-solid btn-sm deleteBtn" onclick="deleteBtn('{{ route('blog.destroy', $blog->id) }}')"><i class="fa fa-trash text-white"></i></button>
