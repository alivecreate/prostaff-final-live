                        ...
                        <div class="digital-add needs-validation">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="heading" id="validationCustomtitle" type="text"
                                    value="{{ old('name', optional($category)->heading) }}">
                                ...
                                <label class="col-form-label categories-basic">
                                    ...
                                    <select class="custom-select form-control" name="parent_id">
                                        ...
                                        @foreach($categories as $parentCategory)
                                            <option value="{{$parentCategory->id}}"  @if(old('category_id', optional($category)->id) == $parentCategory->id) selected @endif >{{$parentCategory->name}}</option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" rows="5" cols="12">{{ old('description', optional($category)->description) }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="validationCustom02" class="col-form-label">
                                    Full Description</label>
                                    <textarea id="editor1" name="full_description" cols="10" rows="6">{{ old('full_description', optional($category)->full_description) }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="image_title" id="validationCustomtitle" type="text"
                                    value="{{ old('name', optional($category)->image_title) }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="digital-add needs-validation">
                            ...
                            <div class="form-group">
                                ...
                                type="text"
                                value="{{ old('page_title', optional($category)->page_title) }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('meta_title', optional($category->seo)->meta_title) }}">
                            </div>

                            <div class="form-group">
                                <label class="col-form-label">Meta Description (Max 160 Char)</label>
                                <textarea rows="4" name="meta_description" cols="12">{{ old('meta_description', optional($category->seo)->meta_description) }}</textarea>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-form-label">Meta Keywords (Max 5 Keywords: Saprated by ',' comma )</label>
                                <textarea rows="4" cols="12" name="meta_keyword">{{ old('meta_keyword', optional($category->seo)->meta_keyword) }}</textarea>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" name="search_index">
                                        <option value="1"
                                            @if(old('search_index', optional($category->seo)->search_index) == 1) selected @endif
                                        >Yes</option>

                                        <option value="0"
                                            @if(old('search_index', optional($category->seo)->search_index) == 0) selected @endif
                                        >No</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" name="search_follow">
                                        <option value="1"
                                            ...
                                            @if(old('search_follow', optional($category->seo)->search_follow) == 1) selected @endif         

                                        >Yes</option>
                                        <option value="0"
                                       
                                            @if(old('search_follow', optional($category->seo)->search_follow) == 0) selected @endif 
                                ...
                                <div class="m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated">
                                    <label class="d-block" for="edo-ani">
                                        <input class="radio_animated" id="edo-ani" type="radio"
                                            name="status" checked value="1"
                                             @if(old('status', optional($category)->status) == 1) checked @endif 
                                            >
                                        Enable
                                    </label>
                                    <label class="d-block" for="edo-ani1">
                                        <input class="radio_animated" id="edo-ani1" type="radio"
                                            name="status" value="0"
                                                @if(old('status', optional($category)->status) == 0) checked @endif                  
                                            >
                                        Disable
                                    </label>
                                </div>
