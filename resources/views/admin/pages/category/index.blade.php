    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('category.create')}}" class="btn btn-primary mt-md-0 mt-2">Add New {{ isset($page['name']) ? $page['name'] : 'item' }}</a>
            </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex vendor-list banner-section">
                                        <img src="{{ asset('web/media/sm') }}/{{$category->image}}" height="100" alt=""
                                ...
                                {{-- <td>
                                    {{
                                        getParentCategory($category->parent_id) !== null ? 
                                        getParentCategory($category->parent_id)->name: null
                                    }}
                                </td> --}}
                                <td>
                                ...
                                <td>
                                    ...
                                    class="btn btn-solid btn-sm deleteBtn" onclick="deleteBtn('{{ route('category.destroy', $category->id) }}')"><i class="fa fa-trash text-white"></i></button>
