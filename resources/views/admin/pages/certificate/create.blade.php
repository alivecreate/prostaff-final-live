            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('certificate.index')}}">{{ isset($page['name']) ? $page['name'] : 'item' }}</a></li>
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="general">
                        ...
                        <form class="needs-validation data-form" action="{{ route('certificate.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row editor-label">
                                <label class="col-xl-3 col-md-4">Image / Logo</label>
                                <div class="col-xl-8 col-md-7">
