...
@section('custom-script')
    ...
    <script>
        ...
        $(".certificate .sidebar-submenu").addClass( "menu-open");
    </script>
@endsection
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('certificate.create')}}" class="btn btn-primary mt-md-0 mt-2">Add New {{ isset($page['name']) ? $page['name'] : 'item' }}</a>
            </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex vendor-list banner-section">
                                        <img src="{{ asset('web/media/sm') }}/{{$certificate->image}}" height="100" alt=""
                                ...
                                <td>
                                    ...
                                    class="btn btn-solid btn-sm deleteBtn" onclick="deleteBtn('{{ route('certificate.destroy', $certificate->id) }}')"><i class="fa fa-trash text-white"></i></button>
