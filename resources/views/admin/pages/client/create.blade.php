            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('client.index')}}">{{ isset($page['name']) ? $page['name'] : 'item' }}</a></li>
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="general">
                        ...
                        <form class="needs-validation data-form" action="{{ route('client.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
