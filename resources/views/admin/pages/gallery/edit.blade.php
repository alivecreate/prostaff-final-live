                        ...
                        <div class="digital-add needs-validation">
                            <div class="form-group">
                                ...
                                <input class="form-control slug-generator" name="name" id="validationCustom01" 
                                    type="text"
                                    value="{{ old('name', optional($gallery)->name) }}">
                            </div>
                            
                            <div class="form-group">
                                <label for="validationCustom02" class="col-form-label">
                                    Description</label>
                                    <textarea id="editor1" height="200px" name="description" cols="14" rows="10">{{ old('description', $gallery->description) }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="validationCustom02" class="col-form-label"><span>*</span>
                                    ...
                                    src="{{asset('web')}}/media/md/{{$gallery->image}}" width="200" alt="" /></div>
                    ...
                    <div class="card-body">
                        <div class="digital-add needs-validation">
                            ...
                            <div class="form-group">
                                ...
                                type="text"
                                value="{{ old('page_title', optional($gallery)->page_title) }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('meta_title', optional($gallery->seo)->meta_title) }}">
                            </div>

                            <div class="form-group">
                                <label class="col-form-label">Meta Description (Max 160 Char)</label>
                                <textarea rows="4" name="meta_description" cols="12">{{ old('meta_description', optional($gallery->seo)->meta_description) }}</textarea>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-form-label">Meta Keywords (Max 5 Keywords: Saprated by ',' comma )</label>
                                <textarea rows="4" cols="12" name="meta_keyword">{{ old('meta_keyword', optional($gallery->seo)->meta_keyword) }}</textarea>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" name="search_index">
                                        <option value="1"
                                            @if(old('search_index', optional($gallery->seo)->search_index) == 1) selected @endif
                                        >Yes</option>

                                        <option value="0"
                                            @if(old('search_index', optional($gallery->seo)->search_index) == 0) selected @endif
                                        >No</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" name="search_follow">
                                        <option value="1"
                                            ...
                                            @if(old('search_follow', optional($gallery->seo)->search_follow) == 1) selected @endif         

                                        >Yes</option>
                                        <option value="0"
                                       
                                            @if(old('search_follow', optional($gallery->seo)->search_follow) == 0) selected @endif 
                                    ...
                                    <label class="d-block" for="edo-ani">
                                        <input class="radio_animated" id="edo-ani" type="radio"
                                            name="status" checked value="active"
                                             @if(old('status', optional($gallery)->status) == 'active') checked @endif 
                                            >
                                        Enable
                                    </label>
                                    <label class="d-block" for="edo-ani1">
                                        <input class="radio_animated" id="edo-ani1" type="radio"
                                            name="status" value="deactive"
                                                @if(old('status', optional($gallery)->status) == 'deactive') checked @endif                  
                                            >
                                        Disable
                                    </label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control url-slug" name="slug" id="validationCustomtitle" 
                                    type="text"
                                    value="{{ old('slug', optional($gallery)->slug) }}"
                                    >
                            </div>
    ...
    <div class="row mt-4">
                                    @foreach($gallery->images as $oldImage)
                                        <div class="col-3 my-2">
                                            ...
                                            <form action="{{route('deleteGalleryImage', $oldImage->image)}}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
