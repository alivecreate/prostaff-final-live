...
<script>
        ...
        $(".industry .sidebar-submenu").addClass( "menu-open");
    </script>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('industry.index')}}">{{ isset($page['name']) ? $page['name'] : 'item' }}</a></li>
...
@endif
    ...
    <form class="needs-validation data-form" 
        action="{{route('industry.update', $industry->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    <div class="container-fluid">
                        ...
                        <div class="digital-add needs-validation">
                            <div class="form-group">
                                ...
                                <input class="form-control slug-generator" name="name" id="validationCustom01" 
                                    type="text"
                                    value="{{ old('name', optional($industry)->name) }}">
                            </div>
                            
                            <div class="form-group">
                                <label for="validationCustom02" class="col-form-label">
                                    Description</label>
                                    <textarea id="editor1" height="200px" name="description" cols="14" rows="10">{{ old('description', $industry->description) }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="validationCustom02" class="col-form-label"><span>*</span>
                                    ...
                                    src="{{asset('web')}}/media/md/{{$industry->image}}" width="200" alt="" /></div>
                    ...
                    <div class="card-body">
                        <div class="digital-add needs-validation">
                            ...
                            <div class="form-group">
                                ...
                                type="text"
                                value="{{ old('page_title', optional($industry)->page_title) }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('meta_title', optional($industry->seo)->meta_title) }}">
                            </div>

                            <div class="form-group">
                                <label class="col-form-label">Meta Description (Max 160 Char)</label>
                                <textarea rows="4" name="meta_description" cols="12">{{ old('meta_description', optional($industry->seo)->meta_description) }}</textarea>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-form-label">Meta Keywords (Max 5 Keywords: Saprated by ',' comma )</label>
                                <textarea rows="4" cols="12" name="meta_keyword">{{ old('meta_keyword', optional($industry->seo)->meta_keyword) }}</textarea>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" name="search_index">
                                        <option value="1"
                                            @if(old('search_index', optional($industry->seo)->search_index) == 1) selected @endif
                                        >Yes</option>

                                        <option value="0"
                                            @if(old('search_index', optional($industry->seo)->search_index) == 0) selected @endif
                                        >No</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" name="search_follow">
                                        <option value="1"
                                            ...
                                            @if(old('search_follow', optional($industry->seo)->search_follow) == 1) selected @endif         

                                        >Yes</option>
                                        <option value="0"
                                       
                                            @if(old('search_follow', optional($industry->seo)->search_follow) == 0) selected @endif 
                                    ...
                                    <label class="d-block" for="edo-ani">
                                        <input class="radio_animated" id="edo-ani" type="radio"
                                            name="status" checked value="active"
                                             @if(old('status', optional($industry)->status) == 'active') checked @endif 
                                            >
                                        Enable
                                    </label>
                                    <label class="d-block" for="edo-ani1">
                                        <input class="radio_animated" id="edo-ani1" type="radio"
                                            name="status" value="deactive"
                                                @if(old('status', optional($industry)->status) == 'deactive') checked @endif                  
                                            >
                                        Disable
                                    </label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control url-slug" name="slug" id="validationCustomtitle" 
                                    type="text"
                                    value="{{ old('slug', optional($industry)->slug) }}"
                                    >
                            </div>
    ...
    <div class="row mt-4">
                                    @foreach($industry->images as $oldImage)
                                        <div class="col-3 my-2">
                                            <img src="{{ asset('web/media/sm/'.$oldImage->image) }}" width="100" height="100" alt="Image">
                                            <form action="{{route('deleteIndustryImage', $oldImage->image)}}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
