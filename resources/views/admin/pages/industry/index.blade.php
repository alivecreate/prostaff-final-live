    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('industry.create')}}" class="btn btn-primary mt-md-0 mt-2">Add New {{ isset($page['name']) ? $page['name'] : 'item' }}</a>
            </div>
                            ...
                            <tr>
                                <td>
                                    <div class="row vendor-list banner-section" style="width: 150px;">
                                        <img
                                        src="{{asset('web')}}/media/sm/{{$industry->image}}" widtg="140" alt="" />
                                ...
                                <td>
                                    ...
                                    class="btn btn-solid btn-sm deleteBtn" onclick="deleteBtn('{{ route('industry.destroy', $industry->id) }}')"><i class="fa fa-trash text-white"></i></button>
