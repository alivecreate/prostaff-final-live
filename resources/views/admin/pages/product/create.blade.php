...
<div class="page-body">
    ...
    <form class="needs-validation data-form" action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
    <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="form-group col">
                                    <label for="validationCustom01" class="col-form-label pt-0">
                                        Price</label>
                                    <input class="form-control" name="price" id="validationCustom01" value="{{old('price')}}"
                                ...
                                <div class="form-group col">
                                    ...
                                    value="{{old('discounted_price')}}" type="number">
                                </div>
                            </div>
