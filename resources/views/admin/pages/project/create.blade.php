...
<div class="page-body">
    ...
    <form class="needs-validation data-form" action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
    <div class="container-fluid">
                    ...
                    <div class="digital-add needs-validation">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="customer_name" id="validationCustom01" 
                                    value="{{old('customer_name')}}" type="text">
                            </div>
                            
                            <div class="form-group">
                                <label for="validationCustom01" class="col-form-label pt-0"><span>*</span>
                                    Project Date / Duration</label>
                                <input class="form-control slug-generator" name="project_date" id="validationCustom01" 
                                    value="{{old('project_date')}}" type="text">
                            </div>
                            
                            <div class="form-group">
                                <label for="validationCustom01" class="col-form-label pt-0"><span>*</span>
                                    Project Status</label>
                                <input class="form-control slug-generator" name="project_status" id="validationCustom01" 
                                    value="{{old('project_status')}}" type="text">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="validationCustom02" class="col-form-label">
                                    Description</label>
                                    <textarea id="editor1" height="200px" name="description" cols="14" rows="10">{{old('description')}}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="validationCustom02" class="col-form-label">
                                    Paragraph 1</label>
                                    <textarea id="editor2" height="100px" name="para1" cols="14" rows="6">{{old('para1')}}</textarea>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" name="search_index">
                                        ...
                                        <option value="0"
                                            @if(old('search_index') == 'deactive' && old('search_index') !== null )
                                                selected
                                            @endif
                                        >No</option>
                                    </select>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" name="search_follow">
                                        ...
                                        @if(old('search_follow') == 'deactive' && old('search_follow') !== null )
                                            selected
                                        @endif                    
                                        >No</option>
                                    </select>
