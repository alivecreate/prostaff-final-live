...
<div class="page-body">
    ...
    <form class="needs-validation data-form" action="{{ route('service.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="digital-add needs-validation">
                            ...
                            {{-- <div class="form-group mt-3">
                                <label for="name" class="col-form-label pt-0"><span>*</span>Service Name</label>
                                <input class="form-control slug-generator" name="name" id="name" value="{{ old('name') }}" type="text" required>
                            </div> --}}
...
<div class="form-group">
    ...
    <input type="file" accept="image/*" id="slider_image" name="slider_image" onchange="previewSliderImage(event)">
    <div class="mt-2">
        <img id="slider_image_preview" src="#" alt="Preview" style="display: none; max-width: 300px; border: 1px solid #ccc; padding: 5px;" />
    </div>
</div>
