...
@section('custom-script')
    ...
    <script>
        ...
        $(".team .sidebar-submenu").addClass( "menu-open");
    </script>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('team.index')}}">{{ isset($page['name']) ? $page['name'] : 'item' }}</a></li>
                        ...
                        <form class="needs-validation data-form" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-8 col-md-7">
                                    <input class="form-control" id="validationCustom2" type="text" name="name"
                                        value="@if(old('name')){{old('name')}}@else{{$team->name}}@endif"
                                    >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="validationCustom2" class="col-xl-3 col-md-4">Designation</label>
                                <div class="col-xl-8 col-md-7">
                                    <input class="form-control" id="validationCustom2" type="text" name="designation"
                                    value="@if(old('designation')){{old('designation')}}@else{{$team->designation}}@endif"
                                >
                                </div>
                            </div>
                            ...
                            <div class="form-group row editor-label">
                                ...
                                <div class="col-xl-8 col-md-7">
                                    ...
                                    <img id="image-preview" height="100" src="{{asset('web/media/sm')}}/{{ isset($team->image) ? $team->image : null}}"/>
                                </div>
                            </div>
