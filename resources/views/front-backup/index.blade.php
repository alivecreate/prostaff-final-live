   ...
   <section class="section-b-space beauty-about">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6 col-md-12 text-center"><img
                        src="{{asset('frontend')}}/images/banner/agriness-trading-v1.jpg" alt="" class="img-fluid blur-up lazyload">
                </div>
                    ...
                    <div class="about-section">
                        <div>
                            ...
                            <div class="heading">
                                ...
                                <h2 class="title-inner1">Pure Agriculture and Organic Form</h2>
                                <span class="sec-heading-tagline">We’re Leader in Agriculture Market</span>
                            </div>
                            ...
                            <div class="about-text">
                                ...
                                <ul>
                                    <p><i class="fa fa-check-circle" aria-hidden="true"></i> Exploring the eco-friendly practices and reduced chemical impact.</p>
                                    <p><i class="fa fa-check-circle" aria-hidden="true"></i> Focusing on how organic farming enhances soil structure and health.</p>
                                    <p><i class="fa fa-check-circle" aria-hidden="true"></i> Discussing reduced residue exposure and potential nutrient-rich produce.</p>
                                    <p><i class="fa fa-check-circle" aria-hidden="true"></i> Examining humane livestock practices and contributions to climate change mitigation.</p>
                                </ul>
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('frontend')}}/images/banner/our-product-sm.png"
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('frontend')}}/images/banner/farming-services-sm.png"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('frontend')}}/images/banner/waste-management-sm.png"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                        </div>
                    </a>
                        ...
                        <div class="col pl-0">
                            <div class="theme-tab">
                                ...
                                <ul class="tabs tab-title">
                                    <li class="current"><a href="tab-1">Vegetables</a></li>
                                    @foreach(getCategories() as $category => $key)
                                        <li class=""><a href="tab-{{$key}}">{{$category->name}}</a></li>
                                    @endforeach
                                    
                                    <li class=""><a href="tab-3">Compost & Fertilizers</a></li>
                                    <li class=""><a href="tab-4">Beans</a></li>
                                    <li class=""><a href="tab-5">Spices</a></li>
                                    <li class=""><a href="tab-6">Grains</a></li>
                                    <li class=""><a href="tab-7">Plants and Pots</a></li>
                                </ul>
                                        ...
                                        <div class="five-product no-slider row">
                                                ...
                                                <div class="img-wrapper">
                                                    ...
                                                    <div class="front">
                                                        <a href="product-page(no-sidebar).html"><img
                                                                src="{{asset('frontend')}}/images/vegetables/pro/11.jpg"
                                                                class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                    </div>
                                                    
                                                    <div class="addtocart_btn">
                                                        <button class="add-button add_cart" title="Read More">
                                                            Read More
                                                        </button>
                                            ...
                                            <div class="product-box product-wrap product-style-1">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product-page(no-sidebar).html"><img
                                                                src="{{asset('frontend')}}/images/vegetables/pro/12.jpg"
                                                                class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                    </div>
                                            ...
                                            <div class="product-box product-wrap product-style-1">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product-page(no-sidebar).html"><img
                                                                src="{{asset('frontend')}}/images/vegetables/pro/13.jpg"
                                                                class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                    </div>
                                                ...
                                                <div class="product-detail text-center">
                                                    <a href="product-page(no-sidebar).html">
                                                        <h6>Sweet Corn - Organically Grown</h6>
                                                    </a>
                                                    <h4>₹110.90</h4>
                                                </div>
                                            </div>
                                            <div class="product-box product-wrap product-style-1">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product-page(no-sidebar).html"><img
                                                                src="{{asset('frontend')}}/images/vegetables/pro/14.jpg"
                                                                class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                    </div>
                                            ...
                                            <div class="product-box product-wrap product-style-1">
                                                <div class="img-wrapper">
                                                    ...
                                                    <div class="front">
                                                        <a href="product-page(no-sidebar).html"><img
                                                                src="{{asset('frontend')}}/images/vegetables/pro/15.jpg"
                                                                class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                    </div>
                                            ...
                                            <div class="product-box product-wrap product-style-1">
                                                <div class="img-wrapper">
                                                    ...
                                                    <div class="front">
                                                        <a href="product-page(no-sidebar).html"><img
                                                                src="{{asset('frontend')}}/images/vegetables/pro/16.jpg"
                                                                class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                    </div>
                                                ...
                                                <div class="product-detail text-center">
                                                    <a href="product-page(no-sidebar).html">
                                                        <h6>Fresh Mushrooms - Button</h6>
                                                    </a>
                                                    <h4>₹130.20 <del>₹130.60</del></h4>
                                                </div>
                                            </div>
                                            <div class="product-box product-wrap product-style-1">
                                                <div class="img-wrapper">
    ...
    <section class="p-0 game-parallax effect-cls ">
        <div class="full-banner parallax text-center p-center text-center">
            <img src="{{asset('frontend')}}/images/banner/slider4.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col pl-0">
                        <div class="banner-contain">
                            ...
                            <p class="text-light">Experience the benefits of our advanced drip irrigation methods that significantly improve plant growth and reduce water waste. </p>
                            <a href="#" class="btn btn-solid">Read More</a>
                        ...
                        <div>
                            <div class="media border-0">
                                <div class="text-center">
                                    <img class="text-center" src="{{asset('frontend')}}/images/avtar.jpg" alt="#">
                                </div>
                            </div>
    ...
    <!-- Read More modal popup start-->
    <!-- Read More modal popup end-->
