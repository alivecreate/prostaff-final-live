...
<body class="theme-color-30 mulish-font">
    ...
    <section class="p-0 small-slider">
        <div class="slider-animate home-slider">
            <div>
                <div class="home">
                    <img src="{{asset('frontend')}}/images/vegetables/banner/16.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col pl-0">
            ...
            <div class="vector-slide-8 no-arrow slick-default-margin ratio_square">
                <div class="">
                    <a href="category-page(vegetables).html">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="{{asset('frontend')}}/images/icon/vegetables/veg.png" class="img-fluid" alt="">
                            </div>
                            <h4>Vegetables</h4>
                        </div>
                    </a>
                ...
                <div class="">
                    <a href="#">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="{{asset('frontend')}}/images/icon/vegetables/dairy.png" class="img-fluid" alt="">
                            </div>
                            <h4>Dairy</h4>
                        </div>
                    </a>
                ...
                <div class="">
                    <a href="#">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="{{asset('frontend')}}/images/icon/vegetables/meat.png" class="img-fluid" alt="">
                            </div>
                            <h4>meat</h4>
                        </div>
                    </a>
                ...
                <div class="">
                    <a href="#">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="{{asset('frontend')}}/images/icon/vegetables/care.png" class="img-fluid" alt="">
                            </div>
                            <h4>care</h4>
                        </div>
                    </a>
                ...
                <div class="">
                    <a href="#">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="{{asset('frontend')}}/images/icon/vegetables/cleaning.png" class="img-fluid" alt="">
                            </div>
                            <h4>cleaning</h4>
                        </div>
                    </a>
                ...
                <div class="">
                    <a href="#">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="{{asset('frontend')}}/images/icon/vegetables/noodle.png" class="img-fluid" alt="">
                            </div>
                            <h4>noodle</h4>
                        </div>
                    </a>
                ...
                <div class="">
                    <a href="#">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="{{asset('frontend')}}/images/icon/vegetables/pet.png" class="img-fluid" alt="">
                            </div>
                            <h4>pet</h4>
                        </div>
                    </a>
                ...
                <div class="">
                    <a href="#">
                        <div class="category-boxes">
                            <div class="img-sec">
                                <img src="{{asset('frontend')}}/images/icon/vegetables/tea.png" class="img-fluid" alt="">
                            </div>
                            <h4>tea</h4>
                        </div>
                    </a>
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('frontend')}}/images/vegetables/banner/17.jpg"
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('frontend')}}/images/vegetables/banner/19.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('frontend')}}/images/vegetables/banner/18.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner white-content banner-3">
                                <div>
                    ...
                    <div class="slide-7-demo slick-sm-margin no-arrow">
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/11.jpg"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/12.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/13.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/14.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/15.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/16.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/17.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/18.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                ...
                <div class="col-12">
                    <div class="slide-7-demo slick-sm-margin no-arrow">
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/19.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/20.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/21.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="{{asset('frontend')}}/images/vegetables/pro/22.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                ...
                <div class="row partition2">
                    <div class="col-md-4">
                        <a href="#">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="{{asset('frontend')}}/images/vegetables/banner/22.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="#">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="{{asset('frontend')}}/images/vegetables/banner/23.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="#">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="{{asset('frontend')}}/images/vegetables/banner/24.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="slide-4 no-arrow">
                        <div>
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="{{asset('frontend')}}/images/vegetables/blog/10.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="{{asset('frontend')}}/images/vegetables/blog/11.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="{{asset('frontend')}}/images/vegetables/blog/12.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="{{asset('frontend')}}/images/vegetables/blog/13.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
