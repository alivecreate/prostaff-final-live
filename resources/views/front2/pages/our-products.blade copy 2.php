                                                ...
                                                <div class="mobile-cart-content row my-2 align-items-center">
                                                    ...
                                                    <div class="qty-box col">
                                                        <div class="input-group d-flex align-items-center align-content-center">
                                                            <input type="number" name="quantity[{{$product->id}}]" class="form-control input-number"
                                                                value="0" min="1">
                                                    ...
                                                    <div class="col pl-0">                                        
                                                        <input class="checkbox" type="checkbox" name="selected_product[]" value="{{$product->id}}" id="">
                                                    </div>
                                                </div>
                                        @endforeach
                                    </div>  
