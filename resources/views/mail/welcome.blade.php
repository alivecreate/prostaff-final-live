...
<body style="margin: 20px auto;min-width: 400px;max-width: 800px;">
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <table style=" margin-bottom: 30px;" class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="price"
                                style="line-height: 1.5; padding: 10px;text-align: right;padding-right: 16px;font-size: 14px;color: #000000;text-align:right;border-left: unset;">
